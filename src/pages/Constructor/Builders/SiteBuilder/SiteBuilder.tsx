...
import { addSlider, deleteBlock, deleteSlide, setSectionType, setSections } from "../../../../redux/reducers/sections.reducer";
...
export const SiteBuilder: React.FC<Section> = ({ content, imageURL, sliders, title, type, index }) => {
            ...
            <div className="constructor2-select__section">
                ...
                <div className="constructor2-select-block__section">
                    <select onChange={onTypeChange} defaultValue={type}>
                        {types.map((selectType, index) => <option key={index} value={selectType.value}>{selectType.label}</option>)}
                    </select>
                    <Constructon_icon4 />
                </div>
            </div>

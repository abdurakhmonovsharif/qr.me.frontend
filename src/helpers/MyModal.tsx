...
export const MyModal: React.FC<{ show: boolean, title?: string, toogleModal: (bool: boolean) => void, children: ReactNode, footer?: ReactNode }> = ({ show, title, toogleModal, children, footer }) => {
    return (
        <>
            {show ? (
                <>
